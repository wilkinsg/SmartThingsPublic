...
metadata {
	...
	tiles(scale: 2) {
		standardTile("motion", "device.motion", width: 6, height: 4) {
			state "active", label: 'motion', action: "switch.off", icon: "st.motion.motion.active", backgroundColor: "#00A0DC", nextState: "inactive"
			state "inactive", label: 'no motion', action: "switch.on", icon: "st.motion.motion.inactive", backgroundColor: "#cccccc", nextState: "active"
		}

 ...
 */
definition(
		name: "Notify Me When (Expanded)",
		namespace: "wilkinsg",
		author: "Graham Wilkinson",
		description: "Receive notifications when anything happens in your home (expanded sensors included).",
...
preferences {
	section("Choose one or more, when..."){
		...
		input "sound", "capability.soundSensor", title: "Sound Sensor Detected", required: false, multiple: true
	}
...
def subscribeToEvents() {
    ...
    subscribe(sound, "sound.detected", eventHandler)
}
